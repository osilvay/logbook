---@class LBF_FishingHeader
local LBF_FishingHeader = LB_ModuleLoader:CreateModule("LBF_FishingHeader")
...
function LBF_FishingHeader:ContainerHeaderFrame(containerTable, parentFrame)
  -- container
  ...
  backButton:SetText(backIcon .. " " .. LogBookFishing:LBF_i18n('Back'))
  ...
  settingsButton:SetText(settingsIcon .. " " .. LogBookFishing:LBF_i18n('Settings'))
