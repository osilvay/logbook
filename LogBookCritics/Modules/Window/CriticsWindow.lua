...
function LBC_CriticsWindow:Initialize()
  if not CriticsWindowFrame then
    ...
    criticsWindowFrame:SetTitle("LogBook Criticals")
    criticsWindowFrame:SetStatusText("|cffffffffLog|r|cff57b6ffBook|r |cff4fe368Criticals|r |cff9191a1v0.0.1|r")
...
function LBC_CriticsWindow:CreateCriticsWindowTable()
  ...
  tableData = {
    table = {
      header = {
        {
          text = LogBookCritics:LBC_i18n("ID"),
          description = LogBookCritics:LBC_i18n("ID of the spell."),
          order = 1,
          width = 60,
          height = 60,
          color = "FFFFCC00",
        ...
        {
          text = LogBookCritics:LBC_i18n("Spell name"),
          description = LogBookCritics:LBC_i18n("Spell name and rank."),
          order = 2,
          width = 232,
          height = 60,
          color = "FFFFCC00",
        ...
        {
          text = LogBookCritics:LBC_i18n("Normal"),
          description = LogBookCritics:LBC_i18n("Normal hit or heal."),
          order = 3,
          width = 60,
          height = 60,
          color = "FFFFCC00",
        ...
        {
          text = LogBookCritics:LBC_i18n("Critic"),
          description = LogBookCritics:LBC_i18n("Critic hit or heal."),
          order = 4,
          width = 60,
          height = 60,
          color = "FFFFCC00",
