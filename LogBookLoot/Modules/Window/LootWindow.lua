...
function LBL_LootWindow:Initialize()
	if not LootWindowFrame then
		...
		lootWindowFrame:SetTitle("|cffffffffLog|r|cff57b6ffBook|r |cffe38d4fLoot|r |cffc1c1c1v|r|cff9191a10.0.1|r")
		lootWindowFrame:SetStatusText(LogBookLoot:i18n("LogBook loot management window"))
