---@class LBL_LootHeader
local LBL_LootHeader = LB_ModuleLoader:CreateModule("LBL_LootHeader")
...
function LBL_LootHeader:ContainerHeaderFrame(containerTable, parentFrame)
  -- container
  ...
  local backIcon = "|TInterface\\AddOns\\LogBookLoot\\Images\\back:16:16|t"
  backButton:SetWidth(140)
  backButton:SetPoint("TOPLEFT", parentFrame.frame, "TOPLEFT", 20, -15)
  backButton:SetText(backIcon .. " " .. LogBookLoot:i18n('Back'))
  ...
  local settingsIcon = "|TInterface\\AddOns\\LogBookLoot\\Images\\settings:16:16|t"
  settingsButton:SetWidth(140)
  settingsButton:SetPoint("TOPRIGHT", parentFrame.frame, "TOPRIGHT", -20, -15)
  settingsButton:SetText(settingsIcon .. " " .. LogBookLoot:i18n('Settings'))
