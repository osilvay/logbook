...
function LB_CustomColors:CustomColors(color_index)
    local customColors = {
        ...
        HEAL_CRITICAL = LB_CustomColors:RgbToHex(LogBookCritics.db.char.general.critics.healCriticalColor, "FFAAF01F"),
        HEAL_NORMAL = LB_CustomColors:RgbToHex(LogBookCritics.db.char.general.critics.healNormalColor, "FFCAF575"),
        ...
        UNDEFINED = "FF999999",
        ZERO = "FF991E15",
        ATTACK_NORMAL = LB_CustomColors:RgbToHex(LogBookCritics.db.char.general.critics.attackNormalColor, "FFC0D5E3"),
