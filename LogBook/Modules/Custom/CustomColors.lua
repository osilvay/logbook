...
function LB_CustomColors:CustomColors(color_index)
    local customColors = {
        ...
        HEAL_CRITICAL = LB_CustomColors:RgbToHex(LogBookCritics.db.char.general.critics.healCriticalColor, "FFCDF01F"),
        HEAL_NORMAL = LB_CustomColors:RgbToHex(LogBookCritics.db.char.general.critics.healNormalColor, "ffdbf071"),
        HIGHEST_HIT = LB_CustomColors:RgbToHex(LogBookCritics.db.char.general.critics.highestHitColor, "FF40E040"),
        LOWEST_HIT = LB_CustomColors:RgbToHex(LogBookCritics.db.char.general.critics.lowestHitColor, "FFE04040"),
        HIGHEST_HEAL = LB_CustomColors:RgbToHex(LogBookCritics.db.char.general.critics.highestHealColor, "FF40E040"),
        LOWEST_HEAL = LB_CustomColors:RgbToHex(LogBookCritics.db.char.general.critics.lowestHealColor, "FFE04040"),
        HIGHEST_ATTACK = LB_CustomColors:RgbToHex(LogBookCritics.db.char.general.critics.highestAttackColor, "FF40E040"),
        LOWEST_ATTACK = LB_CustomColors:RgbToHex(LogBookCritics.db.char.general.critics.lowestAttackColor, "FFE04040"),
        UNDEFINED = "FF999999",
        ZERO = "FF991E15",
        ATTACK_NORMAL = LB_CustomColors:RgbToHex(LogBookCritics.db.char.general.critics.attackNormalColor, "ff909090"),
        ATTACK_CRITICAL = LB_CustomColors:RgbToHex(LogBookCritics.db.char.general.critics.attackCriticalColor, "ffc0c0c0"),
        SPELLID = "FFB1EBF8",
        TEXT_VALUE = "FFc0c0c0",
